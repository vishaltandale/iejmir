(function (a) {
  ...
  var i = function (l, k) {
    ...
    this.formatType =
      k.formatType || this.element.data("format-type") || "standard";
    this.format = g.parseFormat(
      k.format ||
    ...
    this.fontAwesome =
      k.fontAwesome || this.element.data("font-awesome") || false;
    this.bootcssVer =
      k.bootcssVer ||
      (this.isInput
    ...
    this.pickerPosition =
      ...
      "bottom-right";
    this.showMeridian =
      k.showMeridian || this.element.data("show-meridian") || false;
    ...
    if ("wheelViewModeNavigationInverseDirection" in k) {
      this.wheelViewModeNavigationInverseDirection =
        k.wheelViewModeNavigationInverseDirection;
    } else {
    ...
    this.todayHighlight =
      k.todayHighlight || this.element.data("date-today-highlight") || false;
    this.weekStart =
      (k.weekStart ||
    ...
    this.setDatesDisabled(
      k.datesDisabled || this.element.data("date-dates-disabled")
    );
    this.setDaysOfWeekDisabled(
      k.daysOfWeekDisabled || this.element.data("date-days-of-week-disabled")
    );
    this.setMinutesDisabled(
      k.minutesDisabled || this.element.data("date-minute-disabled")
    );
    this.setHoursDisabled(
      k.hoursDisabled || this.element.data("date-hour-disabled")
    );
    this.fillDow();
    this.fillMonths();
    this.update();
  ...
  i.prototype = {
    ...
    setDatesDisabled: function (j) {
      ...
      this.datesDisabled = f.map(this.datesDisabled, function (k) {
        return g
          .parseDate(k, this.format, this.language, this.formatType)
          .toDateString();
      });
      this.update();
      this.updateNavArrows();
    ...
    setTitle: function (j, k) {
      return this.picker
        .find(j)
        .find("th:eq(1)")
        .text(this.title === false ? k : this.title);
    },
    ...
    fillMonths: function () {
      ...
      while (j < 12) {
        k +=
          '<span class="month">' +
          a[this.language].monthsShort[j++] +
          "</span>";
      }
      this.picker.find(".datetimepicker-months td").php(k);
    },
    fill: function () {
      ...
      this.picker
        .find("tfoot th.today")
        .text(a[this.language].today || a.en.today)
        .toggle(this.todayBtn !== false);
      this.picker
        .find("tfoot th.clear")
        .text(a[this.language].clear || a.en.clear)
      ...
      while (K.valueOf() < j) {
        ...
        if (
          ...
          f.inArray(K.getUTCDay(), this.daysOfWeekDisabled) !== -1 ||
          f.inArray(K.toDateString(), this.datesDisabled) !== -1
        ) {
          v += " disabled";
        }
      ...
      this.picker.find(".datetimepicker-hours td").php(s.join(""));
      s = [];
      (w = ""), (F = ""), (t = "");
      ...
      this.picker.find(".datetimepicker-minutes td").php(s.join(""));
      var L = this.date.getUTCFullYear();
      var p = this.setTitle(".datetimepicker-months", u)
        .end()
        .find("span")
        .removeClass("active");
      if (L == u) {
      ...
      var J = this.setTitle(".datetimepicker-years", u + "-" + (u + 9))
        .end()
        .find("td");
      u -= 1;
      for (var B = -1; B < 11; B++) {
                ...
                if (o.is(".year")) {
                  ...
                  if (o.is(".hour")) {
                    ...
                    if (o.is(".minute")) {
                      l =
                        parseInt(
                          o.text().substr(o.text().indexOf(":") + 1),
                          10
                        ) || 0;
    ...
    showMode: function (j) {
      ...
      this.picker
        .find(">div")
        .hide()
        .filter(".datetimepicker-" + g.modes[this.viewMode].clsName)
        .css("display", "block");
      this.updateNavArrows();
    },
    reset: function (j) {
  ...
  f.fn.datetimepicker = function (l) {
    ...
    this.each(function () {
      ...
      if (!n) {
        o.data(
          "datetimepicker",
          (n = new i(this, f.extend({}, f.fn.datetimepicker.defaults, m)))
        );
      }
    ...
    parseDate: function (n, w, q, u) {
      ...
      var o = (n && n.toString().match(this.nonpunctuation)) || [],
        ...
        x = {
          ...
          p: function (B, s) {
            return B.setUTCHours(
              s == 1 ? B.getUTCHours() + 12 : B.getUTCHours()
            );
          },
        },
        l,
    ...
    formatDate: function (j, o, q, m) {
      ...
      if (m == "standard") {
        p = {
          ...
          p:
            a[q].meridiem.length == 2
              ? a[q].meridiem[j.getUTCHours() < 12 ? 0 : 1]
              : "",
          h: j.getUTCHours(),
          i: j.getUTCMinutes(),
          s: j.getUTCSeconds(),
        ...
        if (m == "php") {
          p = {
            ...
            S:
              j.getUTCDate() % 10 <= a[q].suffix.length
                ? a[q].suffix[(j.getUTCDate() % 10) - 1]
                : "",
            a:
              a[q].meridiem.length == 2
                ? a[q].meridiem[j.getUTCHours() < 12 ? 0 : 1]
