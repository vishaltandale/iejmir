...
(function (e, t) {
  ...
  (Nt.optgroup = Nt.option),
    ...
    (Nt.th = Nt.td),
    v.support.phpSerialize || (Nt._default = [1, "X<div>", "</div>"]),
    v.fn.extend({
      text: function (e) {
        return v.access(
          this,
        ...
        return v.access(
          ...
          function (e) {
            ...
            if (
              typeof e == "string" &&
              !yt.test(e) &&
              (v.support.phpSerialize || !wt.test(e)) &&
      ...
      domManip: function (e, n, r) {
        ...
        if (v.isFunction(f))
          return this.each(function (i) {
            var s = v(this);
            (e[0] = f.call(this, i, n ? s.php() : t)), s.domManip(e, n, r);
          });
        if (this[0]) {
    ...
    v.extend({
      clone: function (e, t, n) {
        var r, i, s, o;
        v.support.php5Clone || v.isXMLDoc(e) || !wt.test("<" + e.nodeName + ">")
          ? (o = e.cloneNode(!0))
    ...
    (v.fn.load = function (e, n, r) {
      ...
      return (
        ...
        v
          ...
          .done(function (e) {
            (o = arguments),
              u.php(i ? v("<div>").append(e.replace(yn, "")).find(i) : e);
          }),
        this
      );
    }),
