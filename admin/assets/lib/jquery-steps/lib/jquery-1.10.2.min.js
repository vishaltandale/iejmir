...
(function (e, t) {
  ...
  (x.Callbacks = function (e) {
    ...
    (x.support = (function (t) {
      ...
      (s = a.createElement("select")),
        ...
        (t.phpSerialize = !!d.getElementsByTagName("link").length),
  ...
  var ht =
    ...
    At = {
      ...
      _default: x.support.phpSerialize ? [0, "", ""] : [1, "X<div>", "</div>"],
    },
    jt = dt(a),
          ...
          function (e) {
            ...
            if (
              !(
                "string" != typeof e ||
                Tt.test(e) ||
                (!x.support.phpSerialize && mt.test(e)) ||
      ...
      domManip: function (e, t, n) {
        ...
        if (
          ...
          return this.each(function (r) {
            var i = p.eq(r);
            g && (e[0] = h.call(this, r, i.php())), i.domManip(e, t, n);
          });
        if (
          c &&
    ...
    return (
      ...
      s.length > 0 &&
        x
          ...
          .done(function (e) {
            (o = arguments),
              s.php(i ? x("<div>").append(x.parseHTML(e)).find(i) : e);
          })
          .complete(
            r &&
              function (e, t) {
