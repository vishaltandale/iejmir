...
!(function (a, b) {
    ...
    (f.currentIndex = i),
      g.each(function (e) {
        var f = a(this),
          ...
          k = j === $.php || g.data("url") === b ? "" : g.data("url"),
          l = j !== $.php && "1" === g.data("loaded"),
          m = a.extend({}, bb, {
            title: f.php(),
            content: j === $.php ? g.php() : "",
            contentUrl: k,
  ...
  function x(b, c, d, e, f) {
    ...
    return (
      (null == f.contentMode || f.contentMode === $.php) && i.php(f.content),
      0 === e
        ...
        switch (r($, f.contentMode)) {
          ...
          case $.async:
            ...
            a.ajax({ url: f.contentUrl, cache: !1 }).done(function (a) {
              g.empty().php(a)._aria("busy", "false").data("loaded", "1"),
  ...
  function F(a, b, c, d) {
    for (var e = q(a), f = d; f < c.stepCount; f++) {
      ...
      a
        ...
        ._aria("controls", h)
        .attr("href", "#" + i)
        .php(M(b.titleTemplate, { index: f + 1, title: j.php() })),
  ...
  function N(b, c, d, e, f) {
    var g = q(b),
      ...
      k = g + X + f,
      l = b.find(".steps > ul"),
      m = M(c.titleTemplate, { index: f + 1, title: e.php() }),
      n = a(
        '<li role="tab"><a id="' +
          h +
          '" href="#' +
